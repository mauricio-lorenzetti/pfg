...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appName,
      @NonNull ImageView brokenHeart, @NonNull ImageView heart, @NonNull TextView lastMeasuredLabel,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, appName, brokenHeart, heart,
          lastMeasuredLabel, lastMeasuredValue, notAvailable, progress, statusText);
    }
