...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    private HealthServicesManager healthServicesManager() {
      return new HealthServicesManager(singletonCImpl.provideHealthServicesClientProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new MainViewModel(viewModelCImpl.healthServicesManager());
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam,
      ...
      this.provideHealthServicesClientProvider = DoubleCheck.provider(new SwitchingProvider<HealthServicesClient>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) MainModule_ProvideHealthServicesClientFactory.provideHealthServicesClient(singletonCImpl.mainModule, ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
